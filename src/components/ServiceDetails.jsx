export default function ServiceDetails({ service, onBack, onContactClick }) {
    ...
    return (
        ...
        flex justify-center overflow-y-auto">
            ...
            <section className="pt-16 pb-20 text-white w-full max-w-4xl min-h-screen"> 
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-gray-950 p-6 sm:p-10 rounded-xl border border-gray-800 shadow-2xl">
                        ...
                        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-white">{service.title}</h1>
                        <p className="text-base sm:text-lg text-gray-300 mb-8">{service.description}</p>
                        
                        <hr className="border-gray-800 mb-8" />

                        <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-red-500">Service Overview</h2>
