export default function ServiceDetails({ service, onBack }) {
    ...
    return (
        <section className="min-h-screen pt-10 pb-20 text-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-950 p-10 rounded-xl border border-gray-800">
                    ...
                    mt-6">
                        ...
                        rounded border border-red-500 font-medium">
                            Contact Me
                        </a>
                    </div>
                </div>
